...
use auth::{
    BinanceAuth, BinanceConfig as BinanceAuthConfig, BinanceMarket, ZerodhaAuth,
    ZerodhaConfig as ZerodhaAuthConfig,
};
...
impl FeedManager {
    ...
    async fn run_zerodha_feed(
        ...
        info!(
            "Zerodha authentication successful, token: {}...",
            &token[..8]
        );
    ...
    async fn run_binance_feed(
        ...
        info!(
            "Binance auth created for API key: {}...",
            &config.api_key[..8]
        );
